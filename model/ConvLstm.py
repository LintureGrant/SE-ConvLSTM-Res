...
class ConvLSTMCell(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, kernel_size, bias,res_rate):
        """
...
#         self.conv_res = nn.Conv2d(in_channels=self.input_dim+ self.hidden_dim,
#                               out_channels=4 * self.hidden_dim,
#                               kernel_size=1,
#                               padding=0,
#                               bias=False)
    ...
    def forward(self, input_tensor, cur_state):
        ...
        #combined_conv = self.conv(combined)+self.res_rate*self.conv_res(input_tensor)
...
#         self.f1 = nn.Linear(in_features =hidden_dim[0]*data_row_dim[0]*data_row_dim[1], out_features = 10*data_row_dim[1]*data_row_dim[0])
# #         self.f1 = nn.Linear(in_features =32, out_features = 1)
...
#         print(self.f1)
#         print(layer_output_list[0].transpose(2,-1).shape)
#         out=self.f1(layer_output_list[0].transpose(2,-1)).transpose(2,-1)
